...
def getEvap1CompZ() :
    ...
    evap1CompZ = executeGetQuery(sql_query)[0][0]
    return evap1CompZ

def getPumpingFreq() :
    sql_query = "SELECT Pumping_Freq FROM ciceroOut;"
    pumpingFreq = executeGetQuery(sql_query)[0][0]
    return pumpingFreq

def getCompXEarth() :
    sql_query = "SELECT compx_Earth FROM ciceroOut;"
    compXEarth = executeGetQuery(sql_query)[0][0]
    return compXEarth

def getCompYEarth() :
    sql_query = "SELECT compy_Earth FROM ciceroOut;"
    compYEarth = executeGetQuery(sql_query)[0][0]
    return compYEarth

def getCompZEarth() :
    sql_query = "SELECT compz_Earth FROM ciceroOut;"
    compZEarth = executeGetQuery(sql_query)[0][0]
    return compZEarth

def getEvapTime6() :
    sql_query = "SELECT EvapTime6 FROM ciceroOut;"
    evapTime6 = executeGetQuery(sql_query)[0][0]
    return evapTime6

def getCompZ2() :
    sql_query = "SELECT compz2 FROM ciceroOut;"
    compZ2 = executeGetQuery(sql_query)[0][0]
    return compZ2
