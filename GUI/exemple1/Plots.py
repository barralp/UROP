...
class DypoleDatabaseViewer(wx.Frame):
    ...
    def InitUI(self):
        ...
        self.selectionsGrid.CreateGrid(9, 6)
        ...
        self.selectionsGrid.SetColLabelValue(col=3, value='ImageID')
        self.selectionsGrid.SetColLabelValue(col=4, value='Z')
        #Z is dictionary with range & identifier 
        self.selectionsGrid.SetColLabelValue(col=5, value='Parameters')
